...
practice_15::practice_15(HINSTANCE hInstance, const SIZE & windowSize, int option) :
	direct3dApplication(hInstance, windowSize, option)
{
}

practice_15::~practice_15()
{
	SAFE_RELEASE(_mesh);
}

void practice_15::init(void)
{
	...
	_effect = MN_SRC->getEffect("resource/effect/practice_15.fx");

	_mesh = createMesh();
	_textureDiffuse = MN_SRC->getTexture("resource/texture/mapping/DiffuseMap.jpg");
	_textureNormal = MN_SRC->getTexture("resource/texture/mapping/NormalMap.png");
	_textureDisplace = MN_SRC->getTexture("resource/texture/mapping/DisplacementMap.png");
}

void practice_15::update(void)
{
...
void practice_15::draw(void)
{
	...
	_effect->SetTexture("_textureDisplace", _textureDisplace);
...
LPD3DXMESH practice_15::createMesh(void)
{
